from livekit.rtc import TrackKind, VideoBufferType, VideoStream
...
async def on_track_subscribed(
    ...
    print(
        {
            "track": {"name": track.name, "repr": track.__repr__()},
            "publication": {"name": publication.name, "repr": publication.__repr__()},
            "participant": {
